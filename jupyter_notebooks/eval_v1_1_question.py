    ...
    for article in dataset:
        for paragraph in article['paragraphs']:
            for qa in paragraph['qas']:
                ...
                kh_exact_match = metric_max_over_ground_truths(
                    exact_match_score, prediction, ground_truths)
                
                kh_f1 = metric_max_over_ground_truths(f1_score, prediction, ground_truths)
                
                exact_match += kh_exact_match
                f1_scores.append(kh_f1)
                
                question_results.append([qa['id'], kh_exact_match, kh_f1])
