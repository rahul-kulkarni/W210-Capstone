...
from ..processors.mrqa import MRQAFeatures, MRQAProcessor, mrqa_convert_examples_to_features
...
@dataclass
class MRQADataTrainingArguments:
    """
...
class MRQADataset(Dataset):
    ...
    args: MRQADataTrainingArguments
    features: List[MRQAFeatures]
    mode: Split
    ...
    def __init__(
        ...
        with FileLock(lock_path):
            if os.path.exists(cached_features_file) and not args.overwrite_cache:
                ...
                self.features = mrqa_convert_examples_to_features(
                    examples=examples,
                    tokenizer=tokenizer,
