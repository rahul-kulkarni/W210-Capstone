    ...
    class XLNetModelTester(object):
        ...
        def prepare_config_and_inputs(self):
            ...
            perm_mask = torch.zeros(
                self.batch_size, self.seq_length + 1, self.seq_length + 1, dtype=torch.float
            )
        ...
        def create_and_check_xlnet_qa(
            ...
            start_top_log_probs, start_top_index, end_top_log_probs, end_top_index, cls_logits, mems = (
                outputs
            )
