...
setup(
    ...
    entry_points={"console_scripts": ["pytorch_transformers=pytorch_transformers.__main__:main"]},
...
#     packages=find_packages(exclude=["*.tests", "*.tests.*", "tests.*", "tests"]),
#     install_requires=["torch>=0.4.1", "numpy", "boto3", "requests", "tqdm", "regex", "ftfy"],
#     entry_points={
#         "console_scripts": ["pytorch_pretrained_bert=pytorch_pretrained_bert.__main__:main"]
#     },
#     # python_requires='>=3.5.0',
#     tests_require=["pytest"],
#     classifiers=[
